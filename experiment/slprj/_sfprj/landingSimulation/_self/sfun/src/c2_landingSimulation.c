...
#include "landingSimulation_sfun.h"
#include "c2_landingSimulation.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "landingSimulation_sfun_debug_macros.h"
...
static const char * c2_e_debug_family_names[3] = { "cw", "nargin", "nargout" };

static const char * c2_f_debug_family_names[3] = { "density", "nargin",
  "nargout" };

static const char * c2_g_debug_family_names[6] = { "area", "nargin", "nargout",
  "speed", "rocketDiameter", "airDrag" };

/* Function Declarations */
static void initialize_c2_landingSimulation(SFc2_landingSimulationInstanceStruct
  *chartInstance);
static void initialize_params_c2_landingSimulation
  (SFc2_landingSimulationInstanceStruct *chartInstance);
static void enable_c2_landingSimulation(SFc2_landingSimulationInstanceStruct
  *chartInstance);
static void disable_c2_landingSimulation(SFc2_landingSimulationInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_landingSimulation
  (SFc2_landingSimulationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_landingSimulation
  (SFc2_landingSimulationInstanceStruct *chartInstance);
static void set_sim_state_c2_landingSimulation
  (SFc2_landingSimulationInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_landingSimulation(SFc2_landingSimulationInstanceStruct
  *chartInstance);
static void sf_gateway_c2_landingSimulation(SFc2_landingSimulationInstanceStruct
  *chartInstance);
static void mdl_start_c2_landingSimulation(SFc2_landingSimulationInstanceStruct *
  chartInstance);
static void initSimStructsc2_landingSimulation
  (SFc2_landingSimulationInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_landingSimulationInstanceStruct
  *chartInstance, const mxArray *c2_b_acceleration, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_landingSimulationInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_landingSimulationInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_landingSimulationInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_landingSimulation, const
  char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_landingSimulationInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_landingSimulationInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_landingSimulation(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c2_is_active_c2_landingSimulation = 0U;
}
  ...
  (SFc2_landingSimulationInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_landingSimulation;
  ...
  (SFc2_landingSimulationInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_acceleration = c2_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c2_is_active_c2_landingSimulation = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c2_landingSimulation",
       c2_u, 1)), "is_active_c2_landingSimulation");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_landingSimulation(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_thrust, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_gravity, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_airDrag, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_d_nargin, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_d_nargout, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c_speed, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c_rocketDiameter, 4U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_airDrag, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_SCRIPT_FCN(2, 0);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_e_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_d_rocketDiameter, 2U,
    c2_sf_marshallOut, c2_sf_marshallIn);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_landingSimulationInstanceStruct *chartInstance;
  chartInstance = (SFc2_landingSimulationInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c2_b_acceleration, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_acceleration),
    &c2_thisId);
  sf_mex_destroy(&c2_b_acceleration);
  return c2_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_b_acceleration;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_landingSimulationInstanceStruct *chartInstance;
  chartInstance = (SFc2_landingSimulationInstanceStruct *)chartInstanceVoid;
  c2_b_acceleration = sf_mex_dup(c2_mxArrayInData);
...
const mxArray *sf_c2_landingSimulation_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_landingSimulation), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_landingSimulation);
  return c2_y;
}
...
mxArray *sf_c2_landingSimulation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_landingSimulation_get_post_codegen_info();
...
mxArray *sf_c2_landingSimulation_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_landingSimulation_jit_fallback_info(void)
{
...
mxArray *sf_c2_landingSimulation_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_landingSimulation(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"acceleration\",},{M[8],M[0],T\"is_active_c2_landingSimulation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_landingSimulation_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_landingSimulationInstanceStruct *chartInstance =
      (SFc2_landingSimulationInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_landingSimulationMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_landingSimulationMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _landingSimulationMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  chart_debug_initialization(((SFc2_landingSimulationInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
    chartInstanceVar);
  initialize_c2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_landingSimulation(void *chartInstanceVar)
{
  enable_c2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_landingSimulation(void *chartInstanceVar)
{
  disable_c2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_landingSimulation(void *chartInstanceVar)
{
  sf_gateway_c2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_landingSimulation(SimStruct* S)
{
  return get_sim_state_c2_landingSimulation
    ((SFc2_landingSimulationInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_landingSimulation(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_landingSimulation(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_landingSimulationInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_landingSimulation_optimization_info();
    }

    finalize_c2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_landingSimulation((SFc2_landingSimulationInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_landingSimulation(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_landingSimulation(SimStruct *S)
{
  /* Set overwritable ports for inplace optimization */
  ssMdlUpdateIsEmpty(S, 1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_landingSimulation_optimization_info
...
static void mdlRTW_c2_landingSimulation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_landingSimulation(SimStruct *S)
{
  SFc2_landingSimulationInstanceStruct *chartInstance;
  chartInstance = (SFc2_landingSimulationInstanceStruct *)utMalloc(sizeof
    (SFc2_landingSimulationInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_landingSimulationInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_landingSimulation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_landingSimulation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_landingSimulation;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_landingSimulation;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_landingSimulation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_landingSimulation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_landingSimulation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_landingSimulation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_landingSimulation;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_landingSimulation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_landingSimulation;
  ...
  mdl_start_c2_landingSimulation(chartInstance);
}

void c2_landingSimulation_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_landingSimulation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_landingSimulation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_landingSimulation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_landingSimulation_method_dispatcher.\n"
